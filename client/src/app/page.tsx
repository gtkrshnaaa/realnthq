    ...
    <main className="min-h-screen py-4 md:py-6 lg:py-8 w-[90%] max-w-[90%] mx-auto space-y-8">
      ...
      <section className="bg-white/80 backdrop-blur-sm rounded-2xl border border-black/8 p-8 md:p-12 shadow-sm text-center relative overflow-hidden">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-12 pt-8 border-t border-black/8 max-w-5xl mx-auto">
          ...
          <div className="p-3 bg-[#fbfbfa] rounded-xl border border-black/5">
            <span className="block text-xl font-bold text-[#252724]">{org.activeFloorsCount} Floors</span>
            <span className="text-[11px] text-[#252724]/60">Active Office Levels</span>
          </div>
          <div className="p-3 bg-[#fbfbfa] rounded-xl border border-black/5">
            <span className="block text-xl font-bold text-[#252724]">{org.activeDesksCount} Desks</span>
            <span className="text-[11px] text-[#252724]/60">Hot & Dedicated Desks</span>
          </div>
          <div className="p-3 bg-[#fbfbfa] rounded-xl border border-black/5">
            <span className="block text-xl font-bold text-[#252724]">{org.activeMembersCount} Members</span>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="p-6 rounded-2xl bg-white/80 border border-black/8 shadow-sm">
          ...
          <h3 className="text-lg font-bold text-[#252724]">Ambient Spatial Presence</h3>
        ...
        <div className="p-6 rounded-2xl bg-white/80 border border-black/8 shadow-sm">
          ...
          <h3 className="text-lg font-bold text-[#252724]">Organic Soft Knocks</h3>
          <p className="text-xs text-[#252724]/70 mt-2 leading-relaxed">
        ...
        <div className="p-6 rounded-2xl bg-white/80 border border-black/8 shadow-sm">
          ...
          <h3 className="text-lg font-bold text-[#252724]">Async Decision Registers</h3>
          <p className="text-xs text-[#252724]/70 mt-2 leading-relaxed">
