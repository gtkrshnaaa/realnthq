...
export function HandRaisedIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M10.05 4.275a.75.75 0 01.75.75V11.5a.75.75 0 001.5 0V3.75a.75.75 0 011.5 0V11.5a.75.75 0 001.5 0V5.25a.75.75 0 011.5 0v7.697c0 3.328-2.585 6.053-5.91 6.053h-1.08C6.674 19 4.5 16.826 4.5 14.16V8.25a.75.75 0 011.5 0v3.25a.75.75 0 001.5 0V4.275a.75.75 0 011.5 0V11.5a.75.75 0 001.5 0V4.275z" />
    </svg>
  );
}
...
export function LayersIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M6.429 9.75L2.25 12l9.75 5.25 9.75-5.25-4.179-2.25M2.25 15.75l9.75 5.25 9.75-5.25M12 3.75L2.25 9l9.75 5.25L21.75 9 12 3.75z" />
    </svg>
  );
}
