...
export function UserPlusIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M19 7.5v6m3-3h-6m-1.5-3.75a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM3.75 19.5a6.75 6.75 0 0113.5 0v.75H3.75v-.75z" />
    </svg>
  );
}
...
export function ClipboardCheckIcon({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M11.35 3.836c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m8.9-4.414c.376.023.75.05 1.124.08 1.131.09 1.976 1.052 1.976 2.188V8.25M9 13.5l2.25 2.25L15 12m-6 9h6a2.25 2.25 0 002.25-2.25V8.25A2.25 2.25 0 0015 6H9a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 009 21z" />
    </svg>
  );
}
